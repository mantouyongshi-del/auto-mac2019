...
> 2026-09-24 阅读提示：本文是早期 DeepSeek 服务的历史搭建记录，下面的服务范围、端口状态和旧 `/ask` 流程不能代表当前五仓库系统集成现状。当前农场操作规则见 `AGENTS.md`，GEO 接口与验收要求见 `GEO_INTEGRATION_REQUIREMENTS_AND_ACCEPTANCE.md`；与主项目的系统关系见其 `docs/农场系统与GEO接入-20260924.md`。
